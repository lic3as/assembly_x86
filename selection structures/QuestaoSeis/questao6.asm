; inserir um valor de tensão de corrente alternada (AC) e indicar se a tensão foi muito alta, muito baixa ou em um nível aceitável (usar apenas compares, jumps e labels)
        .686
        .model flat,c
        .stack 100h
